...
export const about = {
  ...
  bio: [
    ...
    "Reliability matters to me. If I say I'll be there, I'll be there. If a job's going to take longer or cost more than I first thought, you'll hear it from me before I start, not after — no surprises on the invoice.",
